...
const Contact = () => {
    ...
    return (
        <section className="contact-container  bg-warning pb-5" id='contact'>
            <Container className="pt-5 text-secondary">
                <h3 className="text-center fs-1">Get In Touch</h3>
                <p className="row col-md-8 text-center m-auto">We  would Love to hear from you . Whether you have a question or just want to say hi, fell free to drop a message. I'll try my best to get back to you</p>
                <div className="mt-4">
                    <form onSubmit={handleSubmit(onSubmit)} className="contact-form shadow shadow-lg">
                        <Row>
                            <Col md="6">
                            ...
                            <Col md="6">
                                <div className="contact-group">
                                    <label>Message</label>
                                    <textarea name="message" placeholder='Give us a mail'  {...register("message", { required: true })} required />
                                </div>
                            </Col>
