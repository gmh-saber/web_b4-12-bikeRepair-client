...
const BookList = () => {
    ...
    useEffect(() => {
        axios.get('https://limitless-harbor-90447.herokuapp.com/orderedByEmail?email=' + loggedInUser.email)
            .then(res => {
                setOrders(res.data);
            })
    ...
    const handleDeleteService = (id) => {
        ...
        swal({
            ...
            if (wantDelete) {
                ...
                axios.delete(`https://limitless-harbor-90447.herokuapp.com/cancel-order/${id}`)
                    .then(res => {
