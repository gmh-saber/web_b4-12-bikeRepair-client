    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data) {
          return swal(
            "Successfully Added",
            `You Successfully Added  ${data.email}  as an admin.`,
            "success"
          );
        }
  ...
  return (
    <Container>
      <Form onSubmit={handleSubmit(onSubmit)} className="admin-group">
        <div
          className="p-5 mt-5 bg-white d-flex justify-content-center shadow"
          ...
          <div className="py-md-4">
            ...
            <Form.Row>
              ...
              <Form.Group as={Col} xs="auto">
                <Button type="submit" variant="info" className="main-button">
                  Add Admin
                </Button>
              </Form.Group>
            </Form.Row>
